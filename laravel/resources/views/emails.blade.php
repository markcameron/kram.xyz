  ...
  <div class="block">
    ...
    <table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
      <tbody>
        <tr>
          <td>
            <table width="580" bgcolor="{!! Variables::get('email_color_background') !!}" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit">
              <tbody>
                <tr>
                  <td>
                    <!-- logo -->
                      ...
                      <tbody>
                        <tr>
                          <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                            <div class="imgpop">
                              <a href="{!! Variables::get('email_logo_url') !!}"><img src="{!! Variables::get('email_logo_path') !!}" alt="logo" border="0" style="display:block; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo"></a>
                            </div>
                          </td>
                        </tr>
                      </tbody>
                      ...
                      <tbody>
                        <tr>
                          <td width="270" valign="middle" style="font-family: Helvetica, Arial, sans-serif;font-size: 14px; color: #ffffff;line-height: 24px; padding: 10px 0;" align="right" class="menu" st-content="menu">
                            <a href="{!! Variables::get('email_logo_url') !!}" style="text-decoration: none; color: #ffffff;">{!! Variables::get('site_name') !!}</a>
                          </td>
                          <td width="20"></td>
                        </tr>
                      </tbody>
    ...
    <tr>
      <td>
        <table height="30" align="left" valign="middle" border="0" cellpadding="0" cellspacing="0" class="tablet-button" st-button="edit">
          <tbody>
            <tr>
              <td width="auto" align="center" valign="middle" height="30" style=" background-color:{!! Variables::get('email_color_link') !!}; border-top-left-radius:4px; border-bottom-left-radius:4px;border-top-right-radius:4px; border-bottom-right-radius:4px; background-clip: padding-box;font-size:13px; font-family:Helvetica, arial, sans-serif; text-align:center;  color:#ffffff; font-weight: 300; padding-left:18px; padding-right:18px;">

                <span style="color: #ffffff; font-weight: 300;">
                  <a style="color: #ffffff; text-align:center;text-decoration: none;" href="{!! trim($__env->yieldContent('button-link')) !!}">@yield('button-text')</a>
                </span>
              </td>
            </tr>
          </tbody>
    ...
    <tr>
      <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #95a5a6; text-align:left;line-height: 24px;" st-content="rightimage-paragraph">
        {!! trim($__env->yieldContent('content-link')) !!}
      </td>
    </tr>
    <!-- end of content -->
    <!-- Spacing -->
              ...
              <tbody>
                ...
                <tr>
                  <td align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 10px;color: #999999" st-content="preheader">
                    {!! Variables::get('email_footer') !!}  <a class="hlite" href="{!! Variables::get('email_logo_url') !!}" style="text-decoration: none; color: {!! Variables::get('email_color_link') !!}">{!! Variables::get('email_logo_url') !!}</a>
                  </td>
                </tr>
                <!-- Spacing -->
                <tr>
