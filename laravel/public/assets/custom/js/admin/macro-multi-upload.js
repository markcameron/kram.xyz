(function () {
  ...
  var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
    url: "/admin/ajax/dropzone-upload/User/1/gallery/multiple", // Set the url
    thumbnailWidth: 80,
    thumbnailHeight: 80,
    parallelUploads: 1,
 ...
 (function () {
   ...
   myDropzone.on("addedfile", function(file) {
     // Hookup the start button
     file.previewElement.querySelector("."+ scope +"-start").onclick = function() { myDropzone.enqueueFile(file); };
   });
   ...
   myDropzone.on("sending", function(file, xhr) {
     ...
     // And disable the start button
     file.previewElement.querySelector("."+ scope +"-start").setAttribute("disabled", "disabled");
   });
